...
Daily and nightly mean as well as full day mean and were calculated for the quality checked hourly data of all available HOBO measurements of the 2023 term.
...
idx as (
  select m.id, mean.mean_full, night.night_temp, day.day_temp
  from metadata m
  natural join mean
  natural join night
  natural join day
