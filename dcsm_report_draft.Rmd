...
```
50 hours suffered from bad data points and were replaced by NAs. This results in an NA share of 5.5%.
...
```{r qc barplot}
barplot(as.matrix(qc_res_tab), cex.names = 0.5, main = "No. of occurences per quality check")
```
